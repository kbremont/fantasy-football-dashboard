...
import { Home, Trophy, Calendar, TrendingUp, Swords, Activity, Scale, Menu, X, ArrowLeftRight } from 'lucide-react'
...
const navItems = [
  ...
  { path: '/gm-trades', label: 'GM Trades', icon: ArrowLeftRight },
